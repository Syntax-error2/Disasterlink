...
import { ShieldCheck, Mail, Lock, Activity, MapPin, Loader2, Server, AlertCircle, CheckCircle, Terminal, Settings, Building2 } from "lucide-react";
  ...
  useEffect(() => {
    ...
    if (currentSubdomain) {
      ...
      fetch(tenantUrl)
        ...
        .catch(err => {
          console.log("Generic SaaS Mode Active", err);
          setTenant(null);
        });
    } else {
      setTenant(null);
    }
  }, [currentSubdomain, isLocalDev]);
